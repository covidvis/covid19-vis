...
class CovidChart(object):
    ...
    def add_image_column(self, df):
        image_map = {
            'e' : "https://github.com/Murtz5253/covid19-vis/blob/master/images/x-warning.png",
            'g' : "https://github.com/Murtz5253/covid19-vis/blob/master/images/x-gathering.png",
            'c' : "https://vega.github.io/vega-datasets/data/x-border",
            's' : "https://vega.github.io/vega-datasets/data/x-school.png",
            'r' : "https://github.com/Murtz5253/covid19-vis/blob/master/images/x-hamburger.png",
            't' : "https://vega.github.io/vega-datasets/data/x-travel.png",
            'n' : "https://github.com/Murtz5253/covid19-vis/blob/master/images/x-building.png",
            'l' : "https://vega.github.io/vega-datasets/data/x-shelter.png",
            'f' : "https://vega.github.io/vega-datasets/data/x-face.png",
            'a' : "https://vega.github.io/vega-datasets/data/warning.png",
            'd' : "https://vega.github.io/vega-datasets/data/travel.png",
            'k' : "https://vega.github.io/vega-datasets/data/border.png",
            'h' : "https://vega.github.io/vega-datasets/data/shelter.png",
            'm' : "https://vega.github.io/vega-datasets/data/school.png",
            'p' : "https://vega.github.io/vega-datasets/data/face.png",
            'q' : "https://vega.github.io/vega-datasets/data/hamburger.png",
            'o' : "https://vega.github.io/vega-datasets/data/building.png",
            'j' : "https://vega.github.io/vega-datasets/data/gathering.png",
        }
